...
const ColorWheel = ({ value, onChange }) => {
  ...
  return (
    <div className="relative w-36 h-36 mx-auto">
      ...
      >
        {/* Color wheel with gradient segments */}
        <defs>
        ...
        {/* Create smooth color wheel using conic gradient simulation */}
...
const ColorPickerModal = ({ isOpen, onClose, value, onChange, label, copyToClipboard }) => {
  ...
  // Generate a grid of colors based on HSL values
          ...
          >
            ...
            >
              ...
              <div className="mt-4 p-3 bg-gray-50 rounded-lg flex items-center justify-between">
                ...
                <button
                  onClick={() => copyToClipboard(value.toUpperCase(), `${label} copied!`)}
              ...
              <div className="flex gap-2 mt-4">
                ...
                <button
                  onClick={() => {
                    copyToClipboard(value.toUpperCase(), `${label} applied!`);
                    onClose();
                  }}
