...
function Visualizer() {
  ...
  useEffect(() => {
    ...
    if (paletteName) {
      // Find the palette in our preset collection
      ...
      // Check if current colors match any preset palette
  ...
  const loadPresetPaletteWithURL = useCallback((paletteColors, paletteName) => {
    ...
    // Update URL to reflect the current palette
      ...
      <main className="max-w-7xl mx-auto px-8 py-20">
        ...
        <div className="grid lg:grid-cols-4 gap-12">
            ...
            <aside className="lg:col-span-1 bg-white p-8 rounded-[2rem] border border-gray-100 shadow-xl shadow-gray-50 flex flex-col gap-6 self-start">
                ...
                <Link to="/Generate?from=visualizer" className="mt-2 flex items-center justify-center gap-2 h-14 bg-gray-50 hover:bg-gray-100 text-gray-900 rounded-xl transition-all font-bold text-sm">
